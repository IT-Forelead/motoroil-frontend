                                          ...
                                          <div class="menu">
                                            <ul>
                                              <li>
                                                ...
                                                <ul>
                                                  <li><a href="#" onclick="window.location = '18_46';">Battereries &amp;
                                                      Chargers</a></li>
                                                  <li><a href="#" onclick="window.location = '24_64';">Bath &amp;
                                                      Body</a></li>
                                                  <li><a href="#" onclick="window.location = '18_45';">Headphones,
                                                      Headsets</a></li>
                                                  <li><a href="#" onclick="window.location = '18_30';">Home Audio</a>
                                                  </li>
                                                </ul>
                                              </li>
                                            </ul>
                                        ...
                                        <div class="col-md-4 static-menu">
                                          <div class="menu">
                                            <ul>
                                              ...
                                              <li>
                                                <a href="24" onclick="window.location = '24';" class="main-menu">Health
                                                  &amp; Beauty</a>
                                                <ul>
                                                  <li>
                                                    <a href="#">Home Audio</a>
                                ...
                                <div class="row">
                                  <div class="col-md-3">
                                    <a href="index.html" class="image-link">
                                      <span class="thumbnail">
                                        <img class="img-responsive img-border" src="/src/assets/image/catalog/menu/home1.jpg"
                                          alt="image">
                                      </span>
                                  ...
                                  <div class="col-md-3">
                                    <a href="home2.html" class="image-link">
                                      <span class="thumbnail">
                                        <img class="img-responsive img-border" src="/src/assets/image/catalog/menu/home2.jpg"
                                          alt="image">
                                      </span>
                                  ...
                                  <div class="col-md-3">
                                    <a href="home3.html" class="image-link">
                                      <span class="thumbnail">
                                        <img class="img-responsive img-border" src="/src/assets/image/catalog/menu/home3.jpg"
                                          alt="image">
                                      </span>
                                  ...
                                  <div class="col-md-3">
                                    <a href="home4.html" class="image-link">
                                      <span class="thumbnail">
                                        <img class="img-responsive img-border" src="/src/assets/image/catalog/menu/home4.jpg"
                                          alt="image">
                                      </span>
                                  ...
                                  <div class="col-md-3">
                                    <a href="home5.html" class="image-link">
                                      <span class="thumbnail">
                                        <img class="img-responsive img-border" src="/src/assets/image/catalog/menu/home5.jpg"
                                          alt="image">
                                      </span>
                                  ...
                                  <div class="col-md-3">
                                    <a href="home6.html" class="image-link">
                                      <span class="thumbnail">
                                        <img class="img-responsive img-border" src="/src/assets/image/catalog/menu/home6.jpg"
                                          alt="image">
                                      </span>
                                  ...
                                  <div class="col-md-3">
                                    <a href="home7.html" class="image-link">
                                      <span class="thumbnail">
                                        <img class="img-responsive img-border" src="/src/assets/image/catalog/menu/home7.jpg"
                                          alt="image">
                                      </span>
                                  ...
                                  <div class="col-md-3">
                                    <a href="home8.html" class="image-link">
                                      <span class="thumbnail">
                                        <img class="img-responsive img-border" src="/src/assets/image/catalog/menu/home8.jpg"
                                          alt="image">
                                      </span>
                                  ...
                                  <div class="col-md-3">
                                    <a href="html_with_RTL/index.html" class="image-link">
                                      <span class="thumbnail">
                                        <img class="img-responsive img-border" src="/src/assets/image/catalog/menu/rtl.jpg"
                                          alt="image">
                                      </span>
                                  ...
                                  <!-- <div class="col-md-15">
                                      <a href="#" class="image-link"> 
                                          <span class="thumbnail">
                                              <img class="img-responsive img-border" src="/src/assets/image/demo/feature/comming-soon.png" alt="">
                                          </span> 
                                  ...
                                  <div class="col-sm-12">
                                    <div class="row">
                                      <div class="col-md-3 img img1">
                                        <a href="#"><img src="/src/assets/image/catalog/menu/megabanner/image-1.jpg"
                                            alt="banner1"></a>
                                      </div>
                                      <div class="col-md-3 img img2">
                                        <a href="#"><img src="/src/assets/image/catalog/menu/megabanner/image-2.jpg"
                                            alt="banner2"></a>
                                      </div>
                                      <div class="col-md-3 img img3">
                                        <a href="#"><img src="/src/assets/image/catalog/menu/megabanner/image-3.jpg"
                                            alt="banner3"></a>
                                      </div>
                                      <div class="col-md-3 img img4">
                                        <a href="#"><img src="/src/assets/image/catalog/menu/megabanner/image-4.jpg"
                                            alt="banner4"></a>
                                      </div>
                                    </div>
                                  </div>
