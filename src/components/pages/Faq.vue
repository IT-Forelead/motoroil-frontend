	...
	<div class="flex justify-center px-5 py-2 bg-white">
		<div class="container flex flex-col justify-center">
			...
			<div class="flex flex-col justify-center">
				<div class="text-2xl font-semibold text-center text-gray-800 lg:text-4xl">Have any Questions?</div>
				<ul class="flex flex-col justify-center mx-48 divide-y">
					<li class="py-5">
						<button class="flex items-center focus:outline-none">
							<MinusIcon class="w-5 h-5 text-red-500"/>
							<span class="mx-4 text-xl text-gray-700">
								How i can play for my appoinment ?
							</span>
						</button>
						<div class="p-2 my-5 ml-10 border-l-2 border-red-500">
							<p class="px-2 text-gray-500">
								...
								Lorem ipsum dolor sit amet consectetur adipisicing elit. Magni, eum quae. Harum officiis reprehenderit ex quia ducimus minima id provident molestias optio nam quidem.
							</p>
						</div>
					</li>
					<li class="py-5">
