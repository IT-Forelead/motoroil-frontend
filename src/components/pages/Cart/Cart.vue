          ...
          <div class="space-y-5">
            <table class="min-w-full divide-y divide-gray-300">
              <thead class="bg-gray-50">
                <tr>
                  <th
                    scope="col"
                    class="px-3 py-3 text-sm font-medium text-left text-gray-700 uppercase"
                  >
                    {{ $t('product') }}
                  </th>
                  <th
                    scope="col"
                    class="px-3 py-3 text-sm font-medium text-center text-gray-700 uppercase"
                  >
                    {{ $t('price') }}
                  </th>
                  <th
              ...
              <tbody class="bg-white divide-y divide-gray-200">
                <tr
                  v-for="(product, idx) in userStore.cart"
                  :key="idx"
                  class="align-middle"
                >
                  ...
                  <td class="p-3">
                    <div
                      class="grid items-center w-1/2 grid-cols-3 gap-1 px-1.5 py-1 mx-auto rounded-full shadow"
                    >
                      <button
                        @click="
                          plusMinus(
                  ...
                  <td class="p-3">
                    <button
                      @click="userStore.deleteCartItem(product?.id)"
            ...
            <div class="grid grid-cols-2 gap-7">
              <div>
                ...
                <ul class="divide-y">
                  <li
                    v-for="(address, idx) in userStore.addresses"
                    :key="idx"
                ...
                <div
                  class="py-5 font-normal text-gray-700 uppercase rounded-full px-7 text-md bg-gray-50"
                >
                  {{ $t('couponCode') }}
                </div>
                <div class="p-3 text-gray-800">
              ...
              <div>
                <div
                  class="py-5 font-normal text-gray-700 uppercase rounded-full bg-gray-50 px-7 text-md"
                >
                  {{ $t('orderSummary') }}
                </div>
                <div class="p-3 text-gray-800">
