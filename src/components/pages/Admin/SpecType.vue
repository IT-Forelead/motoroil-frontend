        ...
        <div class="container flex flex-col justify-center">
            <div class="grid grid-cols-3 gap-3">
                <div class="col-span-2 ml-3">
                    <div class="p-3 text-2xl font-semibold text-gray-700">Specification Types</div>
                ...
                <div class="p-5 space-y-4 bg-white rounded shadow">
                    <div class="p-3 font-medium text-gray-700 border-b text-md">Add Specification Types</div>
                    ...
                    <button @click="addSpecType()" class="flex justify-center w-full px-4 py-2 text-sm font-medium text-white bg-red-500 border border-transparent rounded-md shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2">Save</button>
                </div>
            </div>
        </div>
    </div>
